<x-guest-layout>
 ...
 @endif
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <!-- Email Address -->
        <div>
            <x-input-label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2" for="email" :value="__('Email')" />
        ...
        <!-- Password -->
        <div class="mt-4">
            <x-input-label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2" for="password" :value="__('Password')" />
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center mr-6">
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <x-primary-button class="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-gray-500 hover:bg-[#7F0001] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                {{ __('Log in') }}
            </x-primary-button>
        </div>
    </form>
