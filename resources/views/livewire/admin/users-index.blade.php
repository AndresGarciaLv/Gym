            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class=" flex px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center align-middle">
                        ...
                        <form action="{{-- {{ route('contactos.destroy', $user->id) }} --}}" method="POST"
                            onsubmit="return confirm('¿Estás seguro que deseas eliminar?');">
                            @csrf
                            @method('DELETE')
                            <button type="submit"
                                class="text-red-600 hover:text-red-900 px-3 py-1 rounded-md bg-red-100 hover:bg-red-200">Eliminar</button>
                        </form>
                    </td>
