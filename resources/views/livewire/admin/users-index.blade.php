<div class="mt-4">
      <form wire:submit="search">
        <div class="flex items-end align-middle mb-5">
            ...
            <a href=""
                class="relative bg-[#34AD3C] text-white px-4 py-2 ml-5 mr-6 rounded hover:bg-[#3D7A41] transition-colors h-full"
                >Agregar</a>
            ...
            <div class="relative ml-5 w-[600px] z-10 flex items-center">
                ...
                <span class="absolute rounded inset-y-0 end-0 grid w-10 place-content-center bg-[#5E0409] hover:bg-[#7F0001] text-white h-full">
