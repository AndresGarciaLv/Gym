        ...
        <div class="flex items-end align-middle mb-5">
            ...
            <div class="flex items-center">
                ...
                <select id="perPage" wire:model="perPage"
                    class="shadow-sm rounded-md border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @foreach ($notices as $notice)
                        <tr>
                            ...
                            <td
                                class="px-2 py-2 text-sm text-gray-500 text-center align-middle whitespace-normal max-w-xs">
                                {{ $notice->content }}
                            </td>
                            <td class="px-2 py-2 whitespace-nowrap text-sm text-gray-500 text-center align-middle">
                                {{ $notice->gym->name }}
...
<script>
    ...
    function confirmDeletion(event) {
        ...
        Swal.fire({
            title: '¿Estás seguro que deseas eliminar el aviso?',
