...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/admin/gyms/{slug}/user-memberships', [UserMembershipController::class, 'membershipsByGym'])->name('admin.gyms.user-memberships');
    ...
    Route::get('notices/{slug}/edit', [NoticeController::class, 'edit'])->name('notices.edit');
    Route::put('/notices/{slug}', [NoticeController::class, 'update'])->name('notices.update');
    Route::delete('/notices/{slug}', [NoticeController::class, 'destroy'])->name('notices.destroy');
